...
const RestaurantMenu = () => {
  ...
  let newMenuList;
  if (menuList != undefined) newMenuList = menuList.slice(1);
  ...
  return (
    <div className="res-detail-info px-48 py-8 mt-0 ">
      ...
      <div className="delivery-info p-4 scroll-smooth overflow-x-scroll whitespace-nowrap custom-scrollbar">
        <div className="distance font-bold">
          <span>{resHeaderInfo?.sla?.slaString}</span> &nbsp;&nbsp;{" "}
          <span>{resHeaderInfo?.costForTwoMessage}</span>
        </div>
